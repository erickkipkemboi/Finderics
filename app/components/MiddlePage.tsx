      ...
      <div
       ...
       <div className="text-2xl font-light">
        ...
        <div className="pt-10 flex space-x-4">
          <Button className="bg-yellow-500 text-xl h-15 font-bold text-white-500 py-3 px-6 w-auto">Check Our Courses</Button>
          <Button className="bg-indigo-500 text-xl  h-15  text-white py-3 px-6 w-auto">About Us</Button>
                  </div>
   </div>
